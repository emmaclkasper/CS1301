...
public class StatMethodCheck_v1 {
	...
	public static void main(String[] args) {
		...
		Constructor<StatOg> defaultConstructor = null,
		...
		*/
		...
		//default
		try {
			defaultConstructor = StatOg.class.getConstructor();
		} catch (Exception e) {}

		//double constructor
		try {
			doubleArrayConstructor = StatOg.class.getConstructor(double[].class);
		} catch (Exception e) {}
		
		//getData
		try {
			getDataMethod = StatOg.class.getMethod("getData", (Class<?> []) null);
		} catch (NoSuchMethodException e) {}

		//setData
		try{
			setDataMethod = StatOg.class.getMethod("setData", new Class[] {double[].class});
		} catch (Exception e){}
		
		//equals
		try {
			equalsMethod = StatOg.class.getMethod("equals", new Class[]{StatOg.class});
		} catch (NoSuchMethodException e) {}

		//min
		try {
			minMethod = StatOg.class.getMethod("min", (Class<?> []) null);
		} catch (NoSuchMethodException e) {}
		
		//max
		try {
			maxMethod = StatOg.class.getMethod("max", (Class<?> []) null);
		} catch (NoSuchMethodException e) {}
		
		//average
		try {
			averageMethod = StatOg.class.getMethod("average", (Class<?> []) null);
		} catch (NoSuchMethodException e) {}
		
		//mode
		try {
			modeMethod = StatOg.class.getMethod("mode", (Class<?> []) null);
		} catch (NoSuchMethodException e) {}
     ...
     */
    private static void testConstructor(String constructorName, Constructor<StatOg> constructor){
