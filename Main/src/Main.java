...
public class Main {
	...
	public static void main(String[] args) {
		...
		double cash = ((scan.nextDouble() + .0049) * 100) / 100.0; // round to
																	// two
																	// decimal
																	// places.
		// Show the users name, age, and assets using the toString() method of
		// the
		// Person class
		...
		while (choice != 5) {
			...
			case 2:
				...
				int houseChoice = scan.nextInt() - 1; // reduce by 1 to index
														// from 0
