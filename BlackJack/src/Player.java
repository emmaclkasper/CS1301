...
* Purpose:This class represents the player and keeps track of the player's score  
...
public class Player {
	 ...
	 * 
	 * @param d
	 *            deck that receives the cards
	 */
	public void returnCardstoDeck(Deck d) {
		Card[] cardsToPutBack = new Card[hand.size()];
		for (int count = 0; count < hand.size(); count++)

		{
			cardsToPutBack[count] = hand.getCards()[count];
			d.addToBottom(cardsToPutBack[count]);
		}
