...
public class StarGraph {
	public static void main(String[] args) {
		...
		if (size <= 0) {
			// returns an error if input is a negative integer and terminates
		...
		System.out.println("");
		if (increment <= 0) {
			// returns error if input is a negative decimal and terminates
		...
		// prints representation of stars
		for (int i = 0; i < x.length; i++) {
			System.out.print(":");
